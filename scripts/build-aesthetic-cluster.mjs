...
const common = {
  preppy: {
    ...
    links:[['Cute Fonts','/cute-fonts.html','Playful bubbles, tiny letters, and kawaii details.'],['Aesthetic Fonts','/aesthetic-fonts.html','Explore the complete aesthetic style collection.'],['Girly Fonts','/girly-fonts.html','Soft script and feminine decorative text.'],['Cursive Text Generator','/','Try the site’s classic flowing scripts.'],['College Block Font Generator','/college-block-font-generator.html','Collegiate block letters for campus and class designs.'],['Varsity Font Generator','/varsity-font-generator.html','Jersey lettering, team names and sports numbers.'],['Y2K Font Generator','/y2k-font-generator.html','Bubble letters, chrome-style bold and star frames from the 2000s.']],
    faqs:[
  ...
  bow: {
    ...
    links:[['Coquette Font Generator','/coquette-font-generator.html','Romantic bows, vintage details, and delicate script.'],['Cute Fonts','/cute-fonts.html','Round, tiny, and playful Unicode letters.'],['Heart Font Generator','/heart-font-generator.html','More ways to frame text with hearts.'],['Cursive Text Generator','/','Create flowing script without bow decorations.'],['Ribbon Font Generator','/ribbon-font-generator.html','🎀 ━🎀━ ౨ৎ ribbon frames and banners around cursive text.']],
    faqs:[
  ...
  coquette: {
    ...
    links:[['Bow Font Generator','/bow-font-generator.html','Explore ribbon-first bow text styles.'],['Girly Fonts','/girly-fonts.html','Try feminine script and bolder pretty styles.'],['Aesthetic Fonts','/aesthetic-fonts.html','Browse dreamy, minimal, gothic, and cute looks.'],['Heart Font Generator','/heart-font-generator.html','Build text around heart symbols.'],['Butterfly Font Generator','/butterfly-font-generator.html','🦋 and Ƹ̵̡Ӝ̵̨̄Ʒ butterfly frames around cursive and script text.'],['Ribbon Font Generator','/ribbon-font-generator.html','🎀 ━🎀━ ౨ৎ ribbon frames and banners around cursive text.'],['Cherry Font Generator','/cherry-font-generator.html','🍒 cherry frames and ♡ 🍒 pairings around cursive and bold text.'],['Strawberry Font Generator','/strawberry-font-generator.html','🍓 strawberry frames and ♡ 🍓 pairings around cursive text.']],
    faqs:[
  ...
  cute: {
    ...
    links:[['Preppy Fonts','/preppy-fonts.html','Try a cleaner, campus-inspired cute look.'],['Girly Fonts','/girly-fonts.html','Add soft script and feminine decoration.'],['Aesthetic Fonts','/aesthetic-fonts.html','Compare cute styles with the wider aesthetic set.'],['Bow Font Generator','/bow-font-generator.html','Frame your text with ribbons and bows.'],['Y2K Font Generator','/y2k-font-generator.html','Bubble letters, chrome-style bold and star frames from the 2000s.'],['Comic Sans Font Generator','/comic-sans-font-generator.html','Casual, rounded, hand-drawn-feel Unicode text in the Comic Sans spirit.'],['Cute Username Generator','/cute-username-generator.html','Sweet, kawaii, soft and pastel username ideas from your name.'],['Nickname Generator','/nickname-generator.html','Cute, funny and cool nicknames built from a real name.'],['Flower Font Generator','/flower-font-generator.html','Cursive and bold text framed with ✿ ❀ 🌸 🌷 flowers.'],['Butterfly Font Generator','/butterfly-font-generator.html','🦋 and Ƹ̵̡Ӝ̵̨̄Ʒ butterfly frames around cursive and script text.'],['Star Font Generator','/star-font-generator.html','★ ☆ ✩ 🌟 star frames around cursive, bold and aesthetic text.'],['Moon Font Generator','/moon-font-generator.html','☾ ☽ 🌙 crescent frames and night-sky text in cursive and italic.'],['Ribbon Font Generator','/ribbon-font-generator.html','🎀 ━🎀━ ౨ৎ ribbon frames and banners around cursive text.'],['Angel Font Generator','/angel-font-generator.html','Halo °。, wings ᯓ, clouds ☁ and 👼 frames around cursive text.'],['Fairy Font Generator','/fairy-font-generator.html','🧚 fairies, ✨ fairy dust and ⋆｡˚ ✧ glitter rings around cursive text.'],['Cherry Font Generator','/cherry-font-generator.html','🍒 cherry frames and ♡ 🍒 pairings around cursive and bold text.'],['Strawberry Font Generator','/strawberry-font-generator.html','🍓 strawberry frames and ♡ 🍓 pairings around cursive text.'],['Sunflower Font Generator','/sunflower-font-generator.html','🌻 sunflower frames and ☀ 🌻 sun pairings around cursive text.'],['Daisy Font Generator','/daisy-font-generator.html','🌼 ❁ ⚘ daisy frames and chains around cursive and kawaii text.'],['Adopt Me Font Generator','/adopt-me-font-generator.html','Cute fonts for Adopt Me pet names, trades and bios.']],
    faqs:[
  ...
  girly: {
    ...
    links:[['Coquette Font Generator','/coquette-font-generator.html','Choose a softer bow-and-ribbon mood.'],['Cute Fonts','/cute-fonts.html','Explore bubbles, tiny letters, and kawaii frames.'],['Heart Font Generator','/heart-font-generator.html','Add varied heart symbols to your words.'],['Aesthetic Fonts','/aesthetic-fonts.html','See every major aesthetic category together.'],['Flower Font Generator','/flower-font-generator.html','Cursive and bold text framed with ✿ ❀ 🌸 🌷 flowers.'],['Sparkle Font Generator','/sparkle-font-generator.html','✦ ✧ ✨ ˖° sparkle and glitter frames around cursive text.'],['Ribbon Font Generator','/ribbon-font-generator.html','🎀 ━🎀━ ౨ৎ ribbon frames and banners around cursive text.'],['Cherry Font Generator','/cherry-font-generator.html','🍒 cherry frames and ♡ 🍒 pairings around cursive and bold text.'],['Strawberry Font Generator','/strawberry-font-generator.html','🍓 strawberry frames and ♡ 🍓 pairings around cursive text.'],['Daisy Font Generator','/daisy-font-generator.html','🌼 ❁ ⚘ daisy frames and chains around cursive and kawaii text.']],
    faqs:[
  ...
  aesthetic: {
    ...
    links:[['Preppy Fonts','/preppy-fonts.html','Polished, campus-inspired letters and symbols.'],['Bow Font Generator','/bow-font-generator.html','Ribbon frames and soft bow combinations.'],['Coquette Font Generator','/coquette-font-generator.html','Delicate romantic script and vintage details.'],['Cute Fonts','/cute-fonts.html','Bubble, tiny, and kawaii-style text.'],['Girly Fonts','/girly-fonts.html','Feminine cursive and pretty bold presets.'],['Heart Font Generator','/heart-font-generator.html','Heart letters and love-symbol styles.'],['Old English Font Generator','/old-english-font-generator.html','Blackletter and Fraktur text, copy and paste.'],['College Block Font Generator','/college-block-font-generator.html','Collegiate block letters and outlined campus lettering.'],['Y2K Font Generator','/y2k-font-generator.html','Bubble letters, chrome-style bold and star frames from the 2000s.'],['TikTok Font Generator','/tiktok-font-generator.html','Fonts for TikTok display names, bios and captions that paste as text.'],['Brat Font Generator','/brat-font-generator.html','Lowercase, plain-sans, deliberately unpolished text for the brat look.'],['Copy and Paste Fonts','/copy-and-paste-fonts.html','Every style in one place: cursive, bold, gothic, bubble, small and more.'],['Cute Username Generator','/cute-username-generator.html','Sweet, kawaii, soft and pastel username ideas from your name.'],['Flower Font Generator','/flower-font-generator.html','Cursive and bold text framed with ✿ ❀ 🌸 🌷 flowers.'],['Butterfly Font Generator','/butterfly-font-generator.html','🦋 and Ƹ̵̡Ӝ̵̨̄Ʒ butterfly frames around cursive and script text.'],['Star Font Generator','/star-font-generator.html','★ ☆ ✩ 🌟 star frames around cursive, bold and aesthetic text.'],['Moon Font Generator','/moon-font-generator.html','☾ ☽ 🌙 crescent frames and night-sky text in cursive and italic.'],['Sparkle Font Generator','/sparkle-font-generator.html','✦ ✧ ✨ ˖° sparkle and glitter frames around cursive text.'],['Angel Font Generator','/angel-font-generator.html','Halo °。, wings ᯓ, clouds ☁ and 👼 frames around cursive text.'],['Fairy Font Generator','/fairy-font-generator.html','🧚 fairies, ✨ fairy dust and ⋆｡˚ ✧ glitter rings around cursive text.'],['Sunflower Font Generator','/sunflower-font-generator.html','🌻 sunflower frames and ☀ 🌻 sun pairings around cursive text.'],['Vine Font Generator','/vine-font-generator.html','🌿 ❦ ✾ vine and tendril frames around cursive text.'],['Leaf Font Generator','/leaf-font-generator.html','🍃 🍂 🍁 ❧ leaf frames for seasonal and nature names.'],['Stylish Text Generator','/stylish-text-generator.html','Stylish fonts and small caps for names, bios and captions.']],
    faqs:[
