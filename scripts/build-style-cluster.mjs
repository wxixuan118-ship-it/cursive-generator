...
const pages = {
  ...
  stylish: {
    ...
    crumb: 'Stylish Text',
    sample: 'Stylish',
    title: 'Stylish Text Generator – Stylish Fonts Copy & Paste (𝒮𝓉𝓎𝓁𝒾𝓈𝒽 ✦ ꜱᴍᴀʟʟ ᴄᴀᴩꜱ)',
    h1: 'Stylish Text Generator',
    kicker: 'Elegant script, small caps, italic and minimal accents',
    description: 'Free stylish text generator — create stylish fonts with elegant script, small caps, italic and refined Unicode accents for names, bios and captions. Copy and paste stylish text anywhere.',
    ...
    uniqueH2: 'Stylish Name Ideas for Bios and Brands',
    uniqueBody: [
