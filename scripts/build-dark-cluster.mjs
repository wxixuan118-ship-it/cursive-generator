...
const pages = {
  ...
  gothic: {
    ...
    crumb: 'Gothic Fonts',
    sample: 'Dark Romance',
    title: 'Gothic Font Generator – Gothic Font Copy and Paste',
    h1: 'Gothic Font Generator: Gothic Font Copy and Paste',
    kicker: 'Blackletter, medieval and elegantly dark',
    description: 'Free gothic font generator with blackletter, Fraktur and Old English Unicode text. Gothic font copy and paste for names, bios, headings and tattoo mock-ups.',
    intro: 'Write in blackletter. This gothic font generator uses Unicode Fraktur — the mathematical alphabet that mirrors medieval blackletter scripts — in both regular and bold weight, framed with crosses, fleur-de-lis and other ornamental characters. The result is elegant and old rather than frightening, and because it is real text, this is a gothic font copy and paste tool as much as a preview: the blackletter stays intact wherever you paste it.',
    ...
    social: 'Gothic text works for gothic and dark-aesthetic usernames, band and music profiles, medieval or fantasy gaming names, decorative headings, tattoo mock-ups and profile bios that want an old, formal weight. Because blackletter is dense, it is far more legible as a short name or heading than as a full sentence. For gothic font copy and paste into a username field, bold Fraktur without a frame is the version most platforms accept.',
    ...
    faqs: [
      ...
      ['Does gothic font copy and paste work everywhere?', 'Almost. Unlike a CSS webfont preview, these are real characters, so the blackletter appearance stays with the text when you copy and paste it into bios, display names, captions and messages. Plain @usernames are the usual exception.'],
