...
FONT_META = {
    ...
    "font_page": "https://www.cursive-text-generator.net/free-fonts/ctg-signature-script.html",
...
def uppercase():
    ...
    data["A"] = glyph(
        742,
        stroke([(62, 12), (150, 282), (258, 718), (350, 418), (444, 12)], 82),
    ...
    data["M"] = glyph(
        948,
        stroke([(72, 16), (126, 250), (164, 714), (274, 468), (390, 90), (506, 470), (602, 714), (676, 440), (754, 20)], 82),
    )
    data["N"] = glyph(
        808,
